        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" name="surat" id="surat" method="post"
                    ...
                    {{ csrf_field() }}
                    <h6 style="font-weight: bold;color: rgb(116, 116, 116)">Data Bayi/Anak</h6>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tanggal_lahir_anak" id="tanggal_lahir_anak"
                    ...
                    <div class="form-group">
                        <label for="jam_lahir_anak">Jam Lahir Anak</label>
                        <input type="time" class="form-control" name="jam_lahir_anak" id="jam_lahir_anak"
                            placeholder="31-12-1969">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="kelahiran_ke" class="form-control" id="kelahiran_ke"
                            placeholder="Kelahiran Anak Ke..">
                        @error('kelahiran_ke')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <select name="pertolongan_kelahiran" class="form-control" id="pertolongan_kelahiran">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="berat_bayi" class="form-control" id="berat_bayi" rows="8"
                            placeholder="Masukan Berat Bayi (kg)"></input>
                        @error('berat_bayi')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input name="Panjang_bayi" type="number" class="form-control" id="Panjang_bayi"
                            placeholder="Masukan Panjang Bayi (cm)">
                        @error('Panjang_bayi')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <br>
                    <h6 style="font-weight: bold;color: rgb(116, 116, 116)">Data Ibu</h6>
                    <div class="form-group">
                    ...
                    <br>
                    <h6 style="font-weight: bold;color: rgb(116, 116, 116)">Data Ayah</h6>
                    <div class="form-group">
                    ...
                    <br>
                    <h6 style="font-weight: bold;color: rgb(116, 116, 116)">Data Pelapor</h6>
                    <br>
                    <div class="form-group">
                    ...
                    <br>
                    <h6 style="font-weight: bold;color: rgb(116, 116, 116)">Data Saksi 1</h6>
                    <div class="form-group">
