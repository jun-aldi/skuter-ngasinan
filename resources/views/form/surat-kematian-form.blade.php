    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form class="form-sample" name="surat" id="surat" method="post" action="{{URL::to("suratkematianform")}}">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label for="no_surat">Nomor Surat</label>
                        <input  type="text" class="form-control" name="no_surat" id="no_surat" placeholder="Masukan Nomor Surat">
                        @error('no_surat')
                    ...
                    <div class="form-group">
                        ...
                        <input onkeyup="isi_otomatis_meninggal()" type="text" class="form-control" name="nik_meninggal" id="nik_meninggal" placeholder="Masukan NIK Meninggal">
                        @error('nik_meninggal')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="bukti_kematian" id="bukti_kematian" placeholder="Bukti Meninggal">
            ...
            <div class="card-body">
                <p class="card-description">
                    ...
                    <div class="form-group">
                        ...
                        <input onkeyup="isi_otomatis_ayah()" type="text" class="form-control" name="nik_ayah" id="nik_ayah" placeholder="Masukan NIK Ayah">
                        @error('nik_ayah')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="card-body">
                <p class="card-description">
                    ...
                    <div class="form-group">
                        ...
                        <input onkeyup="isi_otomatis_ibu()" type="text" class="form-control" name="nik_ibu" id="nik_ibu" placeholder="Masukan NIK ibu">
                        @error('nik_ibu')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="card-body">
                <p class="card-description">
                    ...
                    <div class="form-group">
                        ...
                        <input onkeyup="isi_otomatis_pelapor()" type="text" class="form-control" name="nik_pelapor" id="nik_pelapor" placeholder="Masukan NIK pelapor">
                        @error('nik_pelapor')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="card-body">
                <p class="card-description">
                    ...
                    <div class="form-group">
                        ...
                        <input onkeyup="isi_otomatis_saksi_1()" type="text" class="form-control" name="nik_saksi_1" id="nik_saksi_1" placeholder="Masukan NIK saksi 1">
                        @error('nik_saksi_1')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_saksi_1" id="nama_saksi_1" placeholder="Masukan Nama Lengkap saksi 1">
                        @error('nama_saksi_1')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tanggal_lahir_saksi_1" id="tanggal_lahir_saksi_1" placeholder="31-12-1969">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pekerjaan_saksi_1" class="form-control" id="pekerjaan_saksi_1" placeholder="Masukan Pekerjaan saksi 1">
            ...
            <div class="card-body">
                <p class="card-description">
                    ...
                    <div class="form-group">
                        ...
                        <input onkeyup="isi_otomatis_saksi_2()" type="text" class="form-control" name="nik_saksi_2" id="nik_saksi_2" placeholder="Masukan NIK saksi 2">
                        @error('nik_saksi_2')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_saksi_2" id="nama_saksi_2" placeholder="Masukan Nama Lengkap saksi 2">
                        @error('nama_saksi_2')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tanggal_lahir_saksi_2" id="tanggal_lahir_saksi_2" placeholder="31-12-1969">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pekerjaan_saksi_2" class="form-control" id="pekerjaan_saksi_2" placeholder="Masukan Pekerjaan saksi 2">
